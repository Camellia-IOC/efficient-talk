      ...
      <div class="app-list-block">
        ...
        <div class="app-list">
          <div class="app-list-item"
               ...
               :key="index"
               @click="handleAppOpen(item.appName,item.appUrl)"
          >
            <img :src="item.iconUrl"
                 alt="icon"
                 class="app-icon"
            >
            <label class="app-name">{{ item.appName }}</label>
          </div>
        </div>
      </div>
      <div class="app-list-block">
...
<script setup>
    ...
    // 启动应用
    const handleAppOpen = (title, url) => {
        const config = {
            title: title,
            url: url,
            data: {}
        };
        AppWindowController.openAppWindow("test", config);
    };
